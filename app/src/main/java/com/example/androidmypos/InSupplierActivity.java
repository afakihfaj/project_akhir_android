        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_SUPPLIER,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(InSupplierActivity.this, "Input Berhasil", Toast.LENGTH_SHORT).show();
                                loading.setVisibility(View.GONE);
                            }

                        }catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(InSupplierActivity.this, "Input Gagal" + e.toString(), Toast.LENGTH_SHORT).show();
                            loading.setVisibility(View.GONE);
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(InSupplierActivity.this, "Input Gagal" + error.toString(), Toast.LENGTH_SHORT).show();
                        loading.setVisibility(View.GONE);
                    }
                })
        {
